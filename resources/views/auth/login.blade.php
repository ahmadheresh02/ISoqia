...
@section('title', 'Login - SOQIA')

@section('content')
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
         <div class="max-w-md w-full space-y-8 px-4 py-6">
        <div class="text-center">
            <img src="{{ Storage::url('images/logo.jpeg') }}" alt="Logo" class="mx-auto h-16 w-auto">
        <p class="mt-2 text-center text-lg text-blue-600">Documental Solutions</p>
        </div>
    </div>
